...
: ${AMENT_CURRENT_PREFIX:="/home/matt/CSC212-Roomba-Project/robot_ws/src/install/path_publisher"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/path_publisher/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/path_publisher/environment/path.sh"
